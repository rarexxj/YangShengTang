...
var renderItem = function (category, render) {
    ...
    render += '<li class="dd-item"><div class="dd-handle">' + (category.ShowIndex ? '【首页显示】' : '') + category.Name + '<div class="pull-right action-buttons"><a class="blue" href="' + url_edit + '?categoryId=' + category.Id + '" title="编辑"><i class="icon-pencil bigger-130"></i></a>';
